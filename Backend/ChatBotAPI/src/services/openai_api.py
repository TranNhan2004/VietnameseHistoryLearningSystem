...
class SmoothingModel:
    ...
    def smoothing_question(self, question: str) -> str:
        prompt = f"""
              Bạn là chuyên gia LỊCH SỬ VIỆT NAM.
              Hãy làm mượt câu hỏi dưới đây sao cho đúng tính chất LỊCH SỬ VIỆT NAM và câu từ rõ nghĩa.

              Câu hỏi: {question}

              **LƯU Ý**: Chỉ cần trả về nội dung câu hỏi được làm mượt! KHÔNG trả lời thêm bất cứ thứ gì.
            """
