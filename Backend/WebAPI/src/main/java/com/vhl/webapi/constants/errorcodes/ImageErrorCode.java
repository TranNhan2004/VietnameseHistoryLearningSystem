...
public class ImageErrorCode {
    ...
    public static final String ORDINAL_NUMBER__REQUIRED = "ORDINAL_NUMBER__REQUIRED";
    ...
    public static final String IMAGE__UPLOAD_FAILED = "IMAGE__UPLOAD_FAILED";
    public static final String IMAGE__DELETE_FAILED = "IMAGE__DELETE_FAILED";
